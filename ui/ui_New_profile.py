...
"}")
    ...
    def retranslateUi(self, NewProfile):
        NewProfile.setWindowTitle(QCoreApplication.translate("NewProfile", u"Form", None))
        ...
        self.Button_Cancel.setText(QCoreApplication.translate("NewProfile", u"Konec", None))
