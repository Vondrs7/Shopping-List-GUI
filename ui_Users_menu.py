...
"border: 3px solid rgb(255, 255, 255);\n"
"}")
        self.frame = QFrame(Users_menu)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(10, 10, 488, 281))
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.Label_error_message = QLabel(self.frame)
        self.Label_error_message.setObjectName(u"Label_error_message")
        self.Label_error_message.setGeometry(QRect(30, 230, 251, 16))
        font = QFont()
        ...
        self.Button_Select = QPushButton(self.frame)
        ...
        self.Users = QListWidget(self.frame)
    ...
    def retranslateUi(self, Users_menu):
        Users_menu.setWindowTitle(QCoreApplication.translate("Users_menu", u"Form", None))
